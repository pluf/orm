...
//         ModelUtils::getDataSchema()->createTables(ModelUtils::db(), ModelDescription::getInstance($model));
...
// //         ModelUtils::getDataSchema()->createTables(ModelUtils::db(), ModelDescription::getInstance($book));
// //         ModelUtils::getDataSchema()->createTables(ModelUtils::db(), ModelDescription::getInstance($item));
...
// //         ModelUtils::getDataSchema()->createTables(ModelUtils::db(), ModelDescription::getInstance($tag));
