...
//         $this->assertEquals(4, $this->q()
//             ->field(new Expression('2+2'))
//             ->getOne());

//         $this->assertEquals(4, $this->q('employee')
//             ->field(new Expression('count(*)'))
//             ->getOne());
...
//                 ]
//             ], $this->q()
//                 ->field(new Expression('CAST([] AS int)+CAST([] AS int)', [
//                 3,
//                 3
//             ]), 'now')
//                 ->get());
...
//         $this->assertEquals(5, $this->q()
//             ->field(new Expression('COALESCE([],5)', [
//             null
//         ]), 'null_test')
//             ->getOne());
//     }
    ...
    public function testExpression()
    {
         ...
         */
        if ('pgsql' === $this->pdo->getAttribute(\PDO::ATTR_DRIVER_NAME)) {
            $this->assertEquals('foo', $this->e('select CAST([] AS TEXT)', [
                'foo'
            ])
                ->getOne());
        } else {
            $this->assertEquals('foo', $this->e('select CAST([] AS CHAR)', [
                'foo'
            ])
                ->getOne());
        }
...
//     {
//         // simple value
//         $this->assertEquals('Williams', (string) $this->q('employee')
//             ->field('surname')
//             ->where('name', 'Jack'));
//         // table as sub-query
//         $this->assertEquals('Williams', (string) $this->q($this->q('employee'), 'e2')
//             ->field('surname')
//             ->where('name', 'Jack'));
//         // field as expression
//         $this->assertEquals('Williams', (string) $this->q('employee')
//             ->field($this->e('surname'))
//             ->where('name', 'Jack'));
...
//         $this->assertEquals('7', (string) $this->e('select 3+4'));
//     }
...
//         $this->assertEquals(0, $this->q('employee')
//             ->field(new Expression('count(*)'))
//             ->getOne());
